        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6 shadow-xl">
            ...
            <div className="space-y-6">
              {/* Student Info */}
              <div>
                <h3 className="mb-2 text-lg font-semibold text-gray-900">Student Information</h3>
                <div className="grid gap-4 rounded-lg bg-gray-50 p-4 md:grid-cols-2">
                  ...
                  {selectedRegistration.student_dob && (
                    <div>
                  ...
                  {selectedRegistration.student_gender && (
                    <div>
                      <p className="text-sm text-gray-600">Gender</p>
                      <p className="font-medium">{selectedRegistration.student_gender}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              {/* Guardian Info */}
              <div>
                <h3 className="mb-2 text-lg font-semibold text-gray-900">Guardian Information</h3>
                <div className="grid gap-4 rounded-lg bg-gray-50 p-4 md:grid-cols-2">
                  <div>
                    <p className="text-sm text-gray-600">Name</p>
                    <p className="font-medium">{selectedRegistration.guardian_name}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Email</p>
                    <p className="font-medium">{selectedRegistration.guardian_email}</p>
                  </div>
                  {selectedRegistration.guardian_phone && (
                    <div>
                      <p className="text-sm text-gray-600">Phone</p>
                      <p className="font-medium">{selectedRegistration.guardian_phone}</p>
                    </div>
                  )}
                  {selectedRegistration.guardian_address && (
                    <div className="md:col-span-2">
                      <p className="text-sm text-gray-600">Address</p>
                      <p className="font-medium">{selectedRegistration.guardian_address}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold text-gray-900">Registration Details</h3>
                <div className="grid gap-4 rounded-lg bg-gray-50 p-4 md:grid-cols-2">
                  <div>
                    <p className="text-sm text-gray-600">Registration Fee</p>
                    <p className="font-medium">R{selectedRegistration.registration_fee_amount || 300}</p>
                  </div>
                  {selectedRegistration.discount_amount && selectedRegistration.discount_amount > 0 && (
                    <div>
                      <p className="text-sm text-gray-600">Discount</p>
                      <p className="font-medium text-green-600">
                        {selectedRegistration.discount_amount}% off
                        {selectedRegistration.coupon_code && ` (${selectedRegistration.coupon_code})`}
                      </p>
                    </div>
                  )}
                  <div>
                    <p className="text-sm text-gray-600">Status</p>
                    <p className="font-medium capitalize">{selectedRegistration.status}</p>
                  </div>
                  <div>
              ...
              {selectedRegistration.status === 'pending' && (
                <div className="flex gap-3 border-t pt-4">
                  ...
                  >
                    {processing === selectedRegistration.id ? 'Processing...' : 'Approve & Create Account'}
                  </button>
                  <button
